...
const FloatingConsultButton = () => {
  return (
    <a
      ...
      className="fixed bottom-4 right-4 z-50 inline-flex items-center gap-2 px-3 sm:px-5 py-2.5 sm:py-4 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-400 hover:to-red-500 text-white font-bold rounded-full transition-all duration-300 shadow-2xl hover:shadow-orange-500/50 hover:scale-105 border-2 border-orange-300/40 animate-soft-pulse max-w-[calc(100vw-2rem)]"
    >
