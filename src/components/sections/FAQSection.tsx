...
const faqs = [
  ...
  {
    question: 'Можно ли научиться работать с ChatGPT и Nano Banana с нуля?',
    answer: 'Да. Курс разработан специально для людей без опыта в IT и программировании. С первого занятия вы начинаете работать с реальными инструментами: ChatGPT, Nano Banana, GigaChat, Seedance 2. К концу 3-го месяца уверенно применяете ИИ в работе и зарабатываете с его помощью.',
  },
  {
  ...
  },
  {
    ...
    answer: 'За 3 месяца обучения в школе вы получаете навыки по 6 направлениям: ИИ-ассистент, prompt-инженер, ИИ-дизайнер (Nano Banana), ИИ-видеограф (Seedance 2), ИИ-копирайтер (ChatGPT) и специалист по автоматизации бизнес-процессов с ИИ.',
  },
  {
    question: 'Когда начинается следующий поток курса?',
    answer: 'Ближайший поток стартует 14 сентября 2026 года. В группе всего 30 мест — осталось 7 свободных мест. Чтобы записаться, оставьте заявку на сайте.',
  },
  {
