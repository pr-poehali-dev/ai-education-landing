...
const advantages = [
  {
    title: "Курс для новичков — опыт не нужен",
    icon: "GraduationCap",
    description: "Не знаешь, что такое нейросеть? Отлично — именно для тебя этот курс! Объясняю всё с нуля, простым языком, без IT-жаргона. 90% наших студентов приходят без какого-либо опыта в ИИ и уже на первом занятии получают результат."
  },
  {
  ...
  },
  {
    ...
    icon: "Shield",
    description: "Научим использовать топовые инструменты: Яндекс, Kandinsky работают без VPN, для ChatGPT и Nano Banana понадобится VPN. На первом занятии покажем, как настроить всё за 5 минут!"
  },
  {
