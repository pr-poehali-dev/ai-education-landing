...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Да, VPN понадобится — большинство мощных инструментов (ChatGPT, Nano Banana, Claude) работают только с ним. Можно использовать бесплатный VPN — его вполне достаточно для учёбы. Зарубежная карта пригодится для доступа к платным версиям, но на старте без неё можно обойтись. На первом занятии я покажу, как всё настроить буквально за пару минут — просто и понятно."
  },
  {
