...
const faqItems = [
  ...
  },
  {
    ...
    answer: "Да, VPN понадобится — большинство мощных инструментов (ChatGPT, Nano Banana, Claude) работают только с ним. Зарубежная карта тоже пригодится для доступа к платным версиям. Но не переживайте: на первом занятии я покажу, как настроить и то, и другое буквально за пару минут — всё просто и понятно."
  },
  {
