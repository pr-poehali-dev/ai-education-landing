              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-2 text-orange-300">
                      <Icon name="Users" size={18} className="sm:w-5 sm:h-5 animate-bounce" />
                      <span className="text-xs sm:text-sm font-semibold">Открытая встреча</span>
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  <div className="bg-gradient-to-br from-orange-500/10 to-yellow-500/10 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-orange-500/30 hover:border-orange-400 transition-all duration-300 hover:scale-105 group/item">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="bg-gradient-to-r from-orange-500 to-yellow-500 p-2 rounded-lg group-hover/item:animate-bounce">
                        <Icon name="Coffee" size={18} className="sm:w-5 sm:h-5 text-white" />
                      </div>
                      <span className="text-white font-medium text-xs sm:text-sm">Завтрак</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-500/10 to-yellow-500/10 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-orange-500/30 hover:border-orange-400 transition-all duration-300 hover:scale-105 group/item">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="bg-gradient-to-r from-orange-500 to-yellow-500 p-2 rounded-lg group-hover/item:animate-bounce">
                        <Icon name="MessageCircle" size={18} className="sm:w-5 sm:h-5 text-white" />
                      </div>
                      <span className="text-white font-medium text-xs sm:text-sm">Общение</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-500/10 to-yellow-500/10 rounded-lg sm:rounded-xl p-3 sm:p-4 border border-orange-500/30 hover:border-orange-400 transition-all duration-300 hover:scale-105 group/item">
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="bg-gradient-to-r from-orange-500 to-yellow-500 p-2 rounded-lg group-hover/item:animate-bounce">
                        <Icon name="Lightbulb" size={18} className="sm:w-5 sm:h-5 text-white" />
                      </div>
                      <span className="text-white font-medium text-xs sm:text-sm">Практика</span>
                    </div>
                  </div>
                </div>
